...
SECRET_KEY = 'django-insecure-nzahxa@i$)#-x(6v349^@ikt7cn#!615r8d(z6&v85xrv*!8lk'
...
ROOT_URLCONF = 'laurom_delivery_api.urls'
...
WSGI_APPLICATION = 'laurom_delivery_api.wsgi.application'
